...
VALUES ('bcd6153b-b92b-44fc-bd9a-7adc9e0a30e8', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 40,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);

-- Nurse 2: Barbara Lewandowska
INSERT INTO employee (id, created_at, updated_at, max_weekly_hours, organisation_id, version)
VALUES ('24c0184f-87db-4c08-9541-e39b3e3f972c', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 40,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);

-- Nurse 3: Ewa Nowak (can also do pediatric care)
INSERT INTO employee (id, created_at, updated_at, max_weekly_hours, organisation_id, version)
VALUES ('ef7587a5-be5e-4853-9d63-2d3d3f9e54f2', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 40,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);

-- Nurse 4: Joanna Szymczak (part-time)
INSERT INTO employee (id, created_at, updated_at, max_weekly_hours, organisation_id, version)
VALUES ('f28fe10c-4902-4201-8834-909f3af1287a', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 24,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);

-- Doctor 1: Dr. Jan Kowalski
INSERT INTO employee (id, created_at, updated_at, max_weekly_hours, organisation_id, version)
VALUES ('68641161-d653-4af4-b640-2114fd18d748', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 40,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);

-- Doctor 2: Dr. Maria Piotrowski
INSERT INTO employee (id, created_at, updated_at, max_weekly_hours, organisation_id, version)
VALUES ('ee44815e-dfeb-489b-b9db-62b6e871353a', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 40,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);
...
VALUES ('2a097638-8d8f-431b-a8cb-3b51ea6e0c6b', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0),
       ('4a00246d-69c7-4724-9e76-aae5ff62f320', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0),
       ('72144d96-5373-4487-853f-c8a5bfd489e7', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '7123f3ec-3517-4d3e-98e2-4e98a4cd9581', 0);
...
VALUES ('e8133265-2ef3-4570-b7ae-0bc6004dfa80', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '12a850fe-5e45-44b1-b622-51e0317822cc',
...
VALUES ('3f43e638-cd8f-4e89-8d2a-8190331b7781', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '90e4917c-61af-4aad-95c2-8ecd148f7428',
...
VALUES ('6e887d86-cbcc-4d53-818d-133a4e9ec061', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        '6cee80ca-3734-40e2-a156-8d05c43b41de',
...
VALUES ('5b0f783f-2ce6-46de-a721-1cf0deca0d46', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        'e8133265-2ef3-4570-b7ae-0bc6004dfa80',
...
VALUES ('ea82bdb7-60f7-4f25-a0bd-79b13ce4b7a9', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
        'a352c84d-ef68-4d0c-9da5-16b1a738f509',
